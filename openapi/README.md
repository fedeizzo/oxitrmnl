# Rust API for oxitrmnl-openapi

API for interacting with oxitrmnl webserver
...
This autogenerated project defines an API crate `oxitrmnl-openapi` which contains:
...
#[async_trait]
impl oxitrmnl_openapi::apis::default::Api for ServerImpl {
  // API implementation goes here
}

impl oxitrmnl_openapi::apis::ErrorHandler for ServerImpl {}
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = oxitrmnl_openapi::server::new(Arc::new(ServerImpl));
